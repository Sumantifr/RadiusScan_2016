...
//class declaration
//
class MCJetsMINIAOD_NDMTuplizer : public edm::EDAnalyzer {
   public:
      explicit MCJetsMINIAOD_NDMTuplizer(const edm::ParameterSet&);
      ~MCJetsMINIAOD_NDMTuplizer();
...
//
MCJetsMINIAOD_NDMTuplizer::MCJetsMINIAOD_NDMTuplizer(const edm::ParameterSet& pset) :
...
MCJetsMINIAOD_NDMTuplizer::~MCJetsMINIAOD_NDMTuplizer()
{
...
void
MCJetsMINIAOD_NDMTuplizer::analyze(const edm::Event& iEvent, const edm::EventSetup& pset) {
...
void 
MCJetsMINIAOD_NDMTuplizer::beginJob()
{
	////JEC /////
...
void 
MCJetsMINIAOD_NDMTuplizer::endJob() 
{
// T1->Write();
 //fs->cd();
// fs->Write();
...
void 
MCJetsMINIAOD_NDMTuplizer::beginRun(edm::Run const& iRun, edm::EventSetup const& pset)
{
...
void 
MCJetsMINIAOD_NDMTuplizer::endRun(edm::Run const&, edm::EventSetup const&)
{
}

// ------------ method called when starting to processes a luminosity block  ------------
void 
MCJetsMINIAOD_NDMTuplizer::beginLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method called when ending the processing of a luminosity block  ------------
void 
MCJetsMINIAOD_NDMTuplizer::endLuminosityBlock(edm::LuminosityBlock const&, edm::EventSetup const&)
{
}

// ------------ method fills 'descriptions' with the allowed parameters for the module  ------------
void
MCJetsMINIAOD_NDMTuplizer::fillDescriptions(edm::ConfigurationDescriptions& descriptions) {
...
DEFINE_FWK_MODULE(MCJetsMINIAOD_NDMTuplizer);
/*
