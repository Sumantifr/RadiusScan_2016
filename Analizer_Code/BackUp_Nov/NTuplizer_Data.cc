...
//	cout<<jet1<<" jec "<<(*PFJets[ix])[jet].jecFactor(1)<<endl;
//	cout<<jet1<<" jec "<<recojetjec[ix][0][jet1]<<endl;
...
//	cout<<JetRad[ix]<<" jet "<<jet1+1<<" pt "<<tmppt<<endl;
//	}
...
//    JetCorrectorParameters *p = new JetCorrectorParameters("Fall15_25nsV2_DATA_UncertaintySources_AK4PFchs.txt", name); 
      JetCorrectorParameters *p = new JetCorrectorParameters("Summer16_07Aug2017GH_V10_DATA_UncertaintySources_AK4PFchs.txt", name) ;
