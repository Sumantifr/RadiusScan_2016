...
#elif defined(Data2016)
double pbins[nopbins+1]={0, 74, 97, 133, 196, 272, 330, 395, /*468*/507, 548, 592, 5000.0};
...
double  mcpileup[npileupmx] = {2.55659e-05,5.69423e-05,0.000125506,0.000278901,0.000569423,0.00113071,0.00208595,0.0036048,0.0056094,0.00838214,0.0116697,0.0154569,0.0196102,0.0242981,0.0288244,0.0328778,0.0363989,0.0395668,0.0421884,0.0444022,0.0449972,0.0461012,0.0456096,0.0445626,0.0431123,0.041167,0.0388474,0.0362537,0.0338423,0.0311811,0.0288035,0.0263271,0.0238495,0.021702,0.0193511,0.0175069,0.0157172,0.0141426,0.0130177,0.0114919,0.0104297,0.00917933,0.00819621,0.0074118,0.00659369,0.00594989,0.00526542,0.00462976,0.0042056,0.00357226,0.00315972,0.00272045,0.00237066,0.00203482,0.00178497,0.0015049,0.0012016,0.000949426,0.000854135,0.000651931,0.000503184,0.000461349,0.000334681,0.000274253,0.000237066,0.000169665,0.000130154,0.000122019,6.27528e-05,7.9022e-05,4.53214e-05,2.90522e-05,2.78901e-05,2.32418e-05,2.20797e-05,2.32418e-05,1.74313e-05,1.16209e-05,3.48626e-06,9.2967e-06} ; //For 2016 Summer MC
...
//  edm::EDGetTokenT<reco::BeamSpot> tok_beamspot_;
  ...
  TH1F* Prescale_all_JetpT[nalgo][netarange][nHLTmx] ;
  ...
  for(int ij=0;ij<nalgo;ij++){
    ...
    for (int jk=0;jk<netarange;jk++){	
      ...
      for(int hl=0 ; hl<nHLTmx; hl++){
		  ...
		  sprintf(title,"JetpT for %s %s %s All Jets",JetRad[ij],JetEta[jk],jethlt_name[hl]);
		  
		  Prescale_all_JetpT[ij][jk][hl] = fs->make<TH1F>(name,title,noptbins,ptbins);
		  Prescale_all_JetpT[ij][jk][hl]->Sumw2();
    ...
    sprintf(name,"mcpil%s",JetRad[ij]);
    ...
    //cout<<"id pass "<<looseJetID<<endl;
		...
		if(etatag>=0) {
				...
				for(int isrc=0; isrc<njecmcmx; isrc++){
					...
					if(jet==0) { Prescale_JetpT[ix][etatag][iRecoPTbin[ix]]->Fill(tmppt);}
						Prescale_all_JetpT[ix][etatag][iRecoPTbin[ix]]->Fill(tmppt);
					}	
