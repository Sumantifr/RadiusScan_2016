...
TFile *fileout ;
fileout = new TFile("Unfolded_2016_Data_NTuple_MC_P8_Legacy_new_excor.root","recreate") ;
...
cout<<hist_data[ij][jk]->GetName()<<'\t'<<"Bayesian ChiSq/ndf  "<<chisq_bayes[ij][jk]*1./lastbin[ij][jk]<<"("<<chisq_bayes[ij][jk]<<","<<lastbin[ij][jk]<<")"<<endl;
...
cout<<hist_data[ij][jk]->GetName()<<'\t'<<"SVD ChiSq/ndf  "<<chisq_svd[ij][jk]*1./lastbin[ij][jk]<<"("<<chisq_svd[ij][jk]<<","<<lastbin[ij][jk]<<")"<<endl;
