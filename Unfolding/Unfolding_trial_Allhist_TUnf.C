...
float data_lumi = 15.8;//9.786;//*1.03; //    (BCD=10.354//10.068, EF=7.33, GH=16.145)  9.786,,15.457 (V10)
...
TFile *fileout ;
fileout = new TFile("Data_Legacy_V10_GH.root","recreate") ;
//fileout = new TFile("Unfolded_2016_Data_NTuple_EF_MC_P8_Legacy15_TPcor_excor.root","recreate") ;
...
/*
const char* rootfiles[3] = {"/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/Data_2016/Legacy/JECv18/Legacy2016_07Aug_JECV18_TPCor_excor.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Pythia/NTuples_Hist/Pythia_NTuples_LegacyCor_waRESO_excor.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Pythia/NTuples_Hist/Pythia_NTuples_LegacyCor_waRESO_excor.root"};
*/
//const char* rootfiles[3] = {"/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/Data_2016/Legacy/JECv18/Legacy2016_07Aug_JECV18_TPCor_excor.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Pythia/NTuples_Hist/Pythia_NTuples_LegacyCor_wRESO_excor.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Pythia/NTuples_Hist/Pythia_NTuples_LegacyCor_wRESO_excor.root"};
//const char* rootfiles[3] = {"/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Pythia/NTuples_Hist/Pythia_NTuples_LegacyCor_wRESO_excor.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Herwig/NTuples_Hist/Herwig_LegacyNTuples_JECv10_wRESO_excor_Run2.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Herwig/NTuples_Hist/Herwig_LegacyNTuples_JECv10_wRESO_excor_Run2.root"};
//const char* rootfiles[3] = {"/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/Data_2016/Legacy/JECv18/Legacy2016_07Aug_JECV18_TPCor_excor.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Madgraph/NTuples_Files/Histograms_Madgraph_Summer_w50_excor.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Madgraph/NTuples_Files/Histograms_Madgraph_Summer_w50_excor.root"};


const char* rootfiles[3] = {"/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/Data_2016/Legacy/Eras/Legacy_PROOF_2016GH_wJEC_METFilter_JECv10.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Pythia/NTuples_Hist/Pythia_NTuples_LegacyCor_JECv15_new_excor.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Pythia/NTuples_Hist/Pythia_NTuples_LegacyCor_JECv15_new_excor.root"};
...
if(ij==0) {
//	sprintf(name,"mcjets/JetpT_%s_EtaBin%i_JES0",JetRad[jk],kl+1);
...
//  if(ij==3&& jk==0) {cout<<" err "<<pow(hist_data2[ij][jk]->GetBinError(am+1),2.)<<" data "<<hist_data2[ij][jk]->GetBinContent(am+1)<<" bayes back "<<hist_bayes_back[ij][jk]->GetBinContent(am+1)<<endl;}
	}
...
for(int am=0; am<lastbin[ij][jk]; am++){
if(ij==3&&jk==0){
  cout<<"cov "<<covmatrix_bayes[ij][jk](am,am)<<" data err "<<data_errmat(am,am)<<" RM "<<RM_mat(am,am)<<endl;
  }
}
...
/*
	...
	hist_bayes_back[ij][jk]->Rebin(2);
	hist_svd_back[ij][jk]->Rebin(2);
	hist_BbB_back[ij][jk]->Rebin(2);

	hist_bayes_back[ij][jk]->Scale(1./2);
	hist_svd_back[ij][jk]->Scale(1./2);
	hist_BbB_back[ij][jk]->Scale(1./2);
*/ 
  }
}
