...
//const char *filenames[nfiles] = {"/home/suman/RooUnfold/Unfolded_2016_Data_MC_P8.root","/home/suman/RooUnfold/Unfolded_2016_Data_P8_JERup.root","/home/suman/RooUnfold/Unfolded_2016_Data_P8_JERdn.root"};
...
//const char *filenames[nfiles] = {"/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Madgraph/NTuples_Files/Bin84_Histograms_Madgraph_Summer_w50.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Madgraph/NTuples_Files/Bin84_Histograms_Madgraph_Summer_w50.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Madgraph/NTuples_Files/Bin84_Histograms_Madgraph_Summer_w50.root"};
...
sprintf(name,"JER_Plots/Pt_Plots/Before_Unfolding/%s.eps",c2[ij][jk]->GetName());
...
for(int ij=0; ij<nalgo; ij++){
 ...
 if((ij<2)&&(jk>6)) continue;
  ...
  for(int fg=0; fg<nfiles; fg++){
      ...
      hist_radius_rat[fg-1][ij][jk]->GetYaxis()->SetTitle("JER Varied/JER Nominal");
