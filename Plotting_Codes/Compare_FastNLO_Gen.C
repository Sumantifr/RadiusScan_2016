...
const int nfiles = 6;
const char *filenames[nfiles] = {/*"home/suman/RooUnfold/Unfolded_2016_Data.root",*/"/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Pythia/Summer_Files/Pythia_Summer16_CMSSW8X21_Run2.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Madgraph/Summer2016_8X21/Madgraph2016Summer_Run2.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Herwig/Summer2016_8X21/Herwigpp_Summer2016_8X21.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Pure_Gen/Powheg/Powheg_Pythia/PDF_NNPDF30/hist_Powheg_Pythia_Userhook2_NNPDF30.root"/*hist_Powheg_Pythia_paolo_22.root*/,"/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Pure_Gen/Powheg/Powheg_Herwig/hist_Powheg_Herwig_NNPDF30.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/NLOJet++/FastNLO_Files/AK4_Eta1_FastNLO_Xsection_new.root"};

const int ref = 4;

const char *model_name[nfiles] = {/*"Data2016G",*/"Pythia","Madgraph","Herwigpp","Powheg_Pythia","Powheg_Herwig","FastNLO"};
const int col[nfiles] = {/*1,*/5,2,4,3,6,12};
...
sprintf(name,"ZFastNLO_Gen_Pt_Plots/%s.eps",c2[ij][jk]->GetName());
