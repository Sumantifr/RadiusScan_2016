...
const int nfiles = 4;
/*
const char *filenames[nfiles] = {"/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/Data_2016/RootFiles/hist_RecoJetchs_PU_Data_JetHT2016G_JEC.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Pythia/Summer_Files/Pythia_Summer16_CMSSW8X21_Run2.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Madgraph/Summer2016_8X21/Madgraph2016Summer_Run2.root","/home/suman/CPlusPlus/CMS_Files/Jets_in_CMS/GenJets/Herwig/Summer2016_8X21/Herwigpp_Summer2016_8X21_JER0.root"};
*/
...
const char *model_name[nfiles] = {"Data_2016G","Pythia8","Madgraph","Herwig"};//,"Pythia","Madgraph"};
const int col[nfiles] = {1,5,2,4};//,5,2};
...
//   if(fg==0){ sprintf(name,"mcjets/DiJet_Mass_%s_EtaBin%i",JetRad[ij],jk+1) ;/*sprintf(name,"mcjets/JetpT_%s_EtaBin%i",JetRad[ij],jk+1);*/}
   if((fg>=0)) {sprintf(name,"DiJet_Mass_%s_EtaBin%i",JetRad[ij],jk+1);}
...
sprintf(name,"DiJetMass_Plots/No_Cor/%s.eps",c2[ij][jk]->GetName());
