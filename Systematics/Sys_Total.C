...
ifstream fp2_pt("Unc_Files/PU_Pt_excor.log");
...
ifstream fp7_pt("Unc_Files/Trig_Unc_output.log");
...
ifstream fp2_rad("Unc_Files/PU_Rad_excor.log");
...
ifstream fp7_rad("Unc_Files/Trig_Unc_output.log");

ofstream fptot_pt;
fptot_pt.open("Total_ExpSys_Pt_excor_84_wAK4.log");
ofstream fptot_rad;
fptot_rad.open("Total_ExpSys_Rad_excor_84_wAK4.log");

const int nfiles = 8;
int col[nfiles+1] = {6,2,4,7,9,kBlack,kCyan,kOrange+2,kYellow+2};
int sty[nfiles+1] = {1,2,3,5,6,9,1,4,8};
const char *sys_name[nfiles+1] = {"JES","JER","Pileup","R-dependent", "C^{R}","Statistical uncertainty (Data)","Statistical uncertainty (RM)","Trigger","Total"};
...
TGraphAsymmErrors *stat_rad_RM_hepdata[nalgo][netarange];
TGraphAsymmErrors *stat_rad_data_hepdata[nalgo][netarange];
...
for(int fg=0; fg<nfiles; fg++){
  ...
  for(int jk=0; jk<netarange; jk++){
   ...
   for(int kl=0; kl<noptbins; kl++){
     ...
     if(fg==0) {fp0_pt>>xx1>>xx2>>xx3>>pt_err_up[fg][ij][jk][kl]>>pt_err_dn[fg][ij][jk][kl];}
					  ...
					  fp4_pt>>xx1>>xx2>>xx3>>pt_err_up[fg][ij][jk][kl]>>pt_err_dn[fg][ij][jk][kl]; 
     ...
     if(fg==0) {fp0_rad>>xx1>>xx2>>xx3>>rad_err_up[fg][ij][jk][kl]>>rad_err_dn[fg][ij][jk][kl];}
					  ...
					  fp4_rad>>xx1>>xx2>>xx3>>rad_err_up[fg][ij][jk][kl]>>rad_err_dn[fg][ij][jk][kl];
      ...
      hist_pt_up[fg][ij][jk]->GetXaxis()->SetTitle("Jet p_{T} (GeV)");
      ...
      hist_pt_up[fg][ij][jk]->GetYaxis()->SetTitle("Relative uncertainty in cross section");
      ...
      hist_rad_up[fg][ij][jk]->GetXaxis()->SetTitle("Jet p_{T} (GeV)");
      ...
      hist_rad_up[fg][ij][jk]->GetYaxis()->SetTitleSize(0.06);
      hist_rad_up[fg][ij][jk]->GetYaxis()->SetTitleOffset(5.5);
      hist_rad_up[fg][ij][jk]->GetYaxis()->SetLabelSize(0.05);
      hist_rad_up[fg][ij][jk]->GetYaxis()->SetLabelOffset(0.015);
      hist_rad_up[fg][ij][jk]->GetYaxis()->CenterTitle();
      
      hist_rad_dn[fg][ij][jk]->GetYaxis()->SetTitle("Relative uncertainty");// in Ratio of Xsections");
      hist_rad_dn[fg][ij][jk]->GetYaxis()->SetTitleSize(0.06);
      hist_rad_dn[fg][ij][jk]->GetYaxis()->SetTitleOffset(5.5);
      hist_rad_dn[fg][ij][jk]->GetYaxis()->SetLabelSize(0.05);
      hist_rad_dn[fg][ij][jk]->GetYaxis()->SetLabelOffset(0.015);
      hist_rad_dn[fg][ij][jk]->GetYaxis()->CenterTitle();
      hist_rad_dn[fg][ij][jk]->GetYaxis()->SetTitleOffset(5.5);
 ...
 for(int ij=0; ij<nalgo; ij++){
  ...
  latex.DrawLatex(0.5*(leg_x1+leg_x2)+0.021,leg_y1-0.35,text2);
  }else{
...
//		tdrDraw(stat_pt_data[ij][jk],sty[fg],col[fg],sty[fg],col[fg],0,2);
  ...
  sprintf(name,"Total_Sys_Plots/Ex_Cor_84/Pt_Plots/%s.png",c2[ij][jk]->GetName());
  ...
  latex.DrawLatex(0.5*(leg_x1+leg_x2)+0.29,leg_y1+0.2,text2);
  ...
  for(int fg=0; fg<(nfiles); fg++){
   ...
   hist_rad_up[fg][ij][jk]->GetYaxis()->SetTitleOffset(1.35);
   hist_rad_dn[fg][ij][jk]->GetYaxis()->SetTitleOffset(1.35);
   
   hist_rad_up[fg][ij][jk]->GetXaxis()->SetTitleOffset(0.8);
   hist_rad_dn[fg][ij][jk]->GetXaxis()->SetTitleOffset(0.8);
   
   hist_rad_up[fg][ij][jk]->GetYaxis()->SetLabelOffset(0.0135);
   hist_rad_dn[fg][ij][jk]->GetYaxis()->SetLabelOffset(0.0135);
   
   hist_rad_up[fg][ij][jk]->GetXaxis()->SetLabelOffset(0.0135);
   hist_rad_dn[fg][ij][jk]->GetXaxis()->SetLabelOffset(0.0135);
  ...
  for(int fg=0; fg<(nfiles); fg++){
   ...
   sprintf(name,"Uncertainty_cross_section_ratio_%s_ybin%i_%s_up",JetRad[ij],jk+1,sys_name[fg]);
   hist_rad_up[fg][ij][jk]->SetName(name); 
   sprintf(name,"Uncertainty in cross_section_ratio %s/%s %s %s Up",JetRad[ij],JetRad[3],ybinname[jk],sys_name[fg]);
   hist_rad_up[fg][ij][jk]->SetTitle(name); 
   
   sprintf(name,"Uncertainty_cross_section_ratio_%s_ybin%i_%s_dn",JetRad[ij],jk+1,sys_name[fg]);
   hist_rad_dn[fg][ij][jk]->SetName(name); 
   sprintf(name,"Uncertainty in cross_section_ratio %s/%s %s %s Up",JetRad[ij],JetRad[3],ybinname[jk],sys_name[fg]);
   hist_rad_dn[fg][ij][jk]->SetTitle(name); 
		 ...
		 stat_rad_data_hepdata[ij][jk] = new TGraphAsymmErrors();
		 
		 for(int pt=0; pt < no_ptbins; pt++){
			 int pt1 = pt+1;
			 stat_rad_data_hepdata[ij][jk]->SetPoint(pt,1.01*hist_rad_dn[fg][ij][jk]->GetBinCenter(pt1+1),0);
			 stat_rad_data_hepdata[ij][jk]->SetPointEYhigh(pt,stat_rad_data[ij][jk]->GetErrorYhigh(pt1));
			 stat_rad_data_hepdata[ij][jk]->SetPointEYlow(pt,stat_rad_data[ij][jk]->GetErrorYlow(pt1));		 
			 }
		
		stat_rad_data_hepdata[ij][jk]->SetLineWidth(2);
		stat_rad_data_hepdata[ij][jk]->GetXaxis()->SetRangeUser(min_range,max_range); 
		sprintf(name,"Statistical_uncertainty_cross_section_ratio_%s_ybin%i_%s_data",JetRad[ij],jk+1,sys_name[fg]);
		stat_rad_data_hepdata[ij][jk]->SetName(name);
		sprintf(name,"Statistical (Data) uncertainty in cross_section_ratio %s/%s %s Up",JetRad[ij],JetRad[3],ybinname[jk]);
		stat_rad_data_hepdata[ij][jk]->SetTitle(name);	 
		 ...
		 stat_rad_RM_hepdata[ij][jk] = new TGraphAsymmErrors();
		 
		 for(int pt=0; pt < no_ptbins; pt++){
			 int pt1 = pt+1;
			 stat_rad_RM_hepdata[ij][jk]->SetPoint(pt,0.99*hist_rad_dn[fg][ij][jk]->GetBinCenter(pt1+1),0);
			 stat_rad_RM_hepdata[ij][jk]->SetPointEYhigh(pt,stat_rad_RM[ij][jk]->GetErrorYhigh(pt1));
			 stat_rad_RM_hepdata[ij][jk]->SetPointEYlow(pt,stat_rad_RM[ij][jk]->GetErrorYlow(pt1));		 
			 }
		 
		 stat_rad_RM_hepdata[ij][jk]->SetLineWidth(2);
		 stat_rad_RM_hepdata[ij][jk]->SetLineColor(kRed-2);
		 stat_rad_RM_hepdata[ij][jk]->GetXaxis()->SetRangeUser(min_range,max_range);
		 sprintf(name,"Statistical_uncertainty_cross_section_ratio_%s_ybin%i_%s_RM",JetRad[ij],jk+1,sys_name[fg]);
		 stat_rad_RM_hepdata[ij][jk]->SetName(name);
		 sprintf(name,"Statistical (RM) uncertainty in cross_section_ratio %s/%s %s Up",JetRad[ij],JetRad[3],ybinname[jk]);
		 stat_rad_RM_hepdata[ij][jk]->SetTitle(name);
  ...
  sprintf(name,"Total_Sys_Plots/Ex_Cor_84/Ratio_Plots/%s.png",c3[ij][jk]->GetName());
...
//	fptot_pt<<ij+1<<'\t'<<jk+1<<'\t'<<bn<<'\t'<<pt_err_up_tot[ij][jk][bn]<<'\t'<<pt_err_dn_tot[ij][jk][bn]<<endl;  //final
//	fptot_rad<<ij+1<<'\t'<<jk+1<<'\t'<<bn<<'\t'<<rad_err_up_tot[ij][jk][bn]<<'\t'<<rad_err_dn_tot[ij][jk][bn]<<endl; //final

/////	fptot_rad<<ij+1<<'\t'<<jk+1<<'\t'<<bn<<'\t'<<hist_rad_up[nfiles][ij][jk]->GetBinContent(bn+1)<<'\t'<<hist_rad_dn[nfiles][ij][jk]->GetBinContent(bn+1)<<endl;
  }
 }
}
...
TFile *fileout = new TFile("ExpSys_Fig3.root","RECREATE");
fileout->cd();
...
for(int fg=0; fg<(nfiles); fg++){
   ...
   if(fg<5||fg>6){
   if(fg==7) continue;
   hist_rad_up[fg][1][0]->Write();
   hist_rad_dn[fg][1][0]->Write();
   hist_rad_up[fg][7][0]->Write();
   hist_rad_dn[fg][7][0]->Write();
	}else{
		 if(fg==5){
		 stat_rad_data_hepdata[1][0]->SetLineWidth(2);
		 stat_rad_data_hepdata[1][0]->Write();
		 stat_rad_data_hepdata[7][0]->SetLineWidth(2);
		 stat_rad_data_hepdata[7][0]->Write();
		 }
		 if(fg==6){
		 stat_rad_RM_hepdata[1][0]->SetLineWidth(2);
		 stat_rad_RM_hepdata[1][0]->Write();
		 stat_rad_RM_hepdata[7][0]->SetLineWidth(2);
		 stat_rad_RM_hepdata[7][0]->Write();
		 }
	 }
 
  }

gr_rad_tot[1][0]->SetName("Total_sys_error_ak2_y1");
sprintf(name,"Total experiemtal systematic uncertainty in cross_section_ratio %s/%s %s Up",JetRad[1],JetRad[3],ybinname[0]);
gr_rad_tot[1][0]->SetTitle(name);
gr_rad_tot[1][0]->Write();

gr_rad_tot[7][0]->SetName("Total_error_ak8_y1");
sprintf(name,"Total experiemtal systematic uncertainty in cross_section_ratio %s/%s %s Up",JetRad[7],JetRad[3],ybinname[0]);
gr_rad_tot[7][0]->SetTitle(name);
gr_rad_tot[7][0]->Write();
