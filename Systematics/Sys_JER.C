...
//const char *filenames[nfiles] = {"/home/suman/RooUnfold/Unfolded_2016_Data_P8.root","/home/suman/RooUnfold/Unfolded_2016_Data_P8_JERup.root","/home/suman/RooUnfold/Unfolded_2016_Data_P8_JERdn.root"};
//const char *filenames[nfiles] = {"/home/suman/RooUnfold/Unfolded_2016_Data_Herwig.root","/home/suman/RooUnfold/Unfolded_2016_Data_Herwig_JERup.root","/home/suman/RooUnfold/Unfolded_2016_Data_Herwig_JERdn.root"};

//const char *filenames[nfiles] = {"/home/suman/RooUnfold/Unfolded_2016_Data_NTuple_MC_P8_nocor_JER_84.root","/home/suman/RooUnfold/Unfolded_2016_Data_NTuple_MC_P8_nocor_JERup_84.root","/home/suman/RooUnfold/Unfolded_2016_Data_NTuple_MC_P8_nocor_JERdn_84.root"};
const char *filenames[nfiles] = {"/home/suman/RooUnfold/Unfolded_2016_Data_NTuple_MC_P8_nocor_JER.root","/home/suman/RooUnfold/Unfolded_2016_Data_NTuple_MC_P8_nocor_JERup.root","/home/suman/RooUnfold/Unfolded_2016_Data_NTuple_MC_P8_nocor_JERdn.root"};
...
ofstream fp_pt;
fp_pt.open("JER_Pt_wAK5.log");

ofstream fp_rad;
fp_rad.open("JER_Rad_wAK5.log");
...
for(int ij=0; ij<nalgo; ij++){
  for(int jk=0; jk<netarange; jk++){
   ...
   double bs[nfiles] = {0};   
	...
	if(jer_pt_dn[ij][jk][bn]<1.e-6 && jer_pt_up[ij][jk][bn]>1.e-6) { jer_pt_dn[ij][jk][bn] = jer_pt_up[ij][jk][bn] ;}
	if(jer_pt_up[ij][jk][bn]<1.e-6 && jer_pt_dn[ij][jk][bn]>1.e-6) { jer_pt_up[ij][jk][bn] = jer_pt_dn[ij][jk][bn] ;}
	if(jer_rad_dn[ij][jk][bn]<1.e-6 && jer_rad_up[ij][jk][bn]>1.e-6) { jer_rad_dn[ij][jk][bn] = jer_rad_up[ij][jk][bn] ;}
        if(jer_rad_up[ij][jk][bn]<1.e-6 && jer_rad_dn[ij][jk][bn]>1.e-6) { jer_rad_up[ij][jk][bn] = jer_rad_dn[ij][jk][bn] ;}
...
for(int ij=0; ij<nalgo; ij++){
 ...
 sprintf(name,"JER_Pt_%s_EtaBin%i",JetRad[ij],jk+1);
 ...
 gPad->SetLogx(1);
  ...
  sprintf(name,"JER_Plots/Pt_Plots/%s.eps",c2[ij][jk]->GetName());
...
for(int ij=0; ij<nalgo; ij++){
 ...
 if((ij<2)&&(jk>6)) continue;
  ...
  sprintf(name,"JER_Ratio_%s_EtaBin%i",JetRad[ij],jk+1);
...
/*
  sprintf(name,"JER_Plots/Ratio_Plots/%s.eps",c3[ij][jk]->GetName());
